...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <header className="border-b bg-white shadow-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <h1 className="text-2xl font-bold text-[#A97C50]">
              ChaiPani
            </h1>
            <div className="flex gap-4">
              <Link to="/login">
                <Button variant="outline" className="border-[#A97C50] text-[#A97C50] hover:bg-[#A97C50] hover:text-white">Sign In</Button>
              </Link>
              <Link to="/register">
                <Button className="bg-[#A97C50] hover:bg-[#A97C50]/90 text-white">Get Started</Button>
              </Link>
            </div>
          </div>
        </div>
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-[#A97C50] to-[#8B5A3C] text-white py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/register">
              <Button size="lg" className="bg-white text-[#A97C50] hover:bg-white/90 font-semibold">
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4 text-[#2E2E2E]">Everything you need to split expenses</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => {
              ...
              return (
                <Card key={index} className="text-center shadow-lg hover:shadow-xl transition-shadow border-gray-200">
                  <CardHeader>
                    <div className="w-12 h-12 mx-auto mb-4 bg-[#A97C50]/10 rounded-lg flex items-center justify-center">
                      <Icon className="w-6 h-6 text-[#A97C50]" />
                    </div>
                    <CardTitle className="text-lg text-[#2E2E2E]">{feature.title}</CardTitle>
                  </CardHeader>
                  <CardContent>
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-r from-[#A97C50] to-[#8B5A3C] rounded-xl p-8 text-white">
              <h3 className="text-2xl font-bold mb-4">Ready to get started?</h3>
              <p className="text-white/90 mb-6">
                Create your first group and start tracking expenses in under 60 seconds.
              </p>
              <Link to="/register">
                <Button size="lg" className="bg-white text-[#A97C50] hover:bg-white/90 font-semibold w-full">
                  Create Free Account
                  <ArrowRight className="w-4 h-4 ml-2" />
                </Button>
              </Link>
      ...
      <footer className="border-t py-8 px-4">
        <div className="max-w-6xl mx-auto text-center">
          <div className="mb-4">
            <h3 className="text-xl font-bold text-[#A97C50]">
              ChaiPani
            </h3>
          </div>
